    ...
    public partial class Timesheet : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InternDetails_Users_MentorId",
                        column: x => x.MentorId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternDetails_MentorId",
                table: "InternDetails",
                column: "MentorId");

            migrationBuilder.CreateIndex(
                name: "IX_InternDetails_UserId",
                table: "InternDetails",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_UserId_ProjectId_WorkDate",
                table: "Timesheets",
                columns: new[] { "UserId", "ProjectId", "WorkDate" },
                unique: true);
