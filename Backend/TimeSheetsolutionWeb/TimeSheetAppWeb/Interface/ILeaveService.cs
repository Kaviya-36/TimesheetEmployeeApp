...
namespace TimeSheetAppWeb.Interface
{
    public interface ILeaveService
    {
        ...
        Task<ApiResponse<PagedResponse<LeaveResponse>>> GetAllLeavesAsync(int pageNumber, int pageSize, string? search = null, string? status = null, string? sortDir = "desc", int? callerId = null, string? callerRole = null);
