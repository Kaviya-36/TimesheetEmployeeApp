...
export const routes: Routes = [
  ...
  { path: 'employee', canActivate: [authGuard, roleGuard], data: { roles: ['Employee'] }, loadComponent: () => import('./components/employee-dashboard/employee-dashboard.component').then(m => m.EmployeeDashboardComponent) },
  ...
  {path: 'mentor',    canActivate: [authGuard, roleGuard],data: { roles: ['Mentor'] },   loadComponent: () =>import('./components/mentor-dashboard/mentor-dashboard.component').then(m => m.MentorDashboardComponent)},
